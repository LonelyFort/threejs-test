...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            {name: 'projectTakeawayFloor', source: './models/intern/takeawaysFloorTexture.png', type: 'texture' },
            {name: 'projectChallengeFloor', source: './models/intern/challengeFloorTexture.png', type: 'texture' },
            {name: 'projectSkillFloor', source: './models/intern/skillsFloorTexture.png', type: 'texture' },
            {name: 'projectMoveOnFloor', source: './models/intern/movingOnFloorTexture.png', type: 'texture' },
            {name: 'projectFinalFloor', source: './models/intern/finalFloorTexture.png', type: 'texture' },
